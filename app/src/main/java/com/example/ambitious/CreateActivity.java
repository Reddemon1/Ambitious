...
public class CreateActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    private String username,imageCertificate;
    ...
    private void createContest() {
        ...
        if(imageUri == null){
            Toast.makeText(CreateActivity.this,"Please Enter Your Contest Photo",Toast.LENGTH_LONG).show();
    ...
    private void uploadToFirebase(Uri uri) {
        ...
        fileref.putFile(uri).addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                   fileref.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                       ...
                       public void onSuccess(Uri uri) {
                           ...
                           String noParticipant = "0";

                           tblomba lomba = new tblomba(image , name , desc , releaseDate , openDate , endDate,category,username,uid , noParticipant,userid,imageCertificate);
                           database.child(uid).setValue(lomba);
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(CreateActivity.this,"Failed To Upload Photo",Toast.LENGTH_LONG).show();
            }
        });
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> Spinneradapter = new ArrayAdapter<String>(CreateActivity.this,
    ...
    private void contestback() {
        startActivity(new Intent(CreateActivity.this,CreatedActivity.class));
        overridePendingTransition(R.anim.slide_in_left,R.anim.slide_out_right);
        finish();
    }
